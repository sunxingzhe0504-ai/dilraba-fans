...
export const siteMeta: SiteMeta = {
  ...
  bio: "迪丽热巴（Dilraba Dilmurat），中国内地女演员，1992 年出生于新疆乌鲁木齐。以真诚自然的表演、多元的角色塑造与积极正面的公众形象广受喜爱；现为 Dior 全球品牌大使，演艺事务由其个人工作室独立运营。",
  bioEn:
    "Dilraba Dilmurat is a Chinese actress born in Ürümqi, Xinjiang in 1992. Known for sincere performances, diverse roles, and a positive public image, she serves as a global ambassador for Dior and operates through her independent studio.",
  bioExtended: [
    "从《阿娜尔罕》正式出道，到《古剑奇谭》芙蕖的温柔亮相；再到《三生三世十里桃花》《三生三世枕上书》白凤九的深入人心、《长歌行》《你是我的荣耀》的口碑收视双高，以及《公诉》《利剑·玫瑰》《白日提灯》《虽然不能同时拥有一切》《功夫女足》对现实、奇幻与大银幕类型的持续探索——迪丽热巴始终在表演道路上稳步前行，戏路不断拓宽。",
  ...
  bioExtendedEn: [
    "From her debut in Anaerhan to Fuqu in Legend of Chusen; from Bai Fengjiu in Eternal Love and The Pillow Book to Li Changge and Qiao Jingjing — plus Prosecution, Sword Rose, Moonlit Reunion, You Can't Have Everything, and Kung Fu Women's Soccer — Dilraba keeps widening her range across genres.",
